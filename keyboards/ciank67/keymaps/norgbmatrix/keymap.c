...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DVORAKR] = LAYOUT(
        ...
        KC_LCTL,    KC_LWIN, KC_LALT,  LT(_SIGN, KC_TAB),              RSFT_T(KC_SPC), LT(_FN, KC_ENT),  KC_RALT, KC_MENU,                KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
                        ),
    [_SIGN]   = LAYOUT(
        ...
        RESET,       KC_F10,  KC_F11,   KC_F12,   KC_BSLS,         KC_RIGHT_PAREN,    KC_QUOT,    KC_DOUBLE_QUOTE,   KC_UNDERSCORE,    _______,   _______, _______,_______, TG(_QWERTY),
