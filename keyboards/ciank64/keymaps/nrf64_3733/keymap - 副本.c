...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        RGBM_TOG,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
        RESET,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_INSERT,  KC_UP, MO(_SIGN),
        RGB_TOG,    RGBRST, RGB_MOD,              KC_SPC, MO(_FN),          KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
                       ),
    [_SIGN]   = LAYOUT(
        ...
        RESET,       _______,  _______,   _______,   _______,         _______,    _______,    _______,   _______,    KC_END,   KC_PGDOWN, KC_DELETE,_______, KC_TRNS,
        _______,    _______, _______,             KC_SPC,       KC_TRNS,  _______, _______, _______,   _______
                      ),
    [_FN]   = LAYOUT(
...
void keyboard_post_init_user() {
    #ifdef IS31FL3733
    // Shutdown IS31FL3733 if rgb disabled
