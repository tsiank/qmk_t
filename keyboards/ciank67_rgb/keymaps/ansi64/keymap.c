...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DEFAULT] = LAYOUT(
        ...
        KC_LCTL,   KC_LWIN, KC_LALT,   MO(_SIGN),              KC_SPC, MO(_FN),  KC_MENU, KC_RALT,                   KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
                       ),
    [_SIGN]   = LAYOUT(
        ...
        _______,    _______, _______, KC_TRNS,              KC_SPC,       KC_TRNS,  _______, _______, _______,   _______, _______, _______
                      ),
    [_FN]   = LAYOUT(
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_INSERT,  KC_UP, KC_DELETE,
    ...
    [_RGBST] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,TO(_DEFAULT),  _______
                     ),
    [_MOUSE] = LAYOUT(
        ...
        KC_MY_COMPUTER,  _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, TO(_DEFAULT)
                     )
};
