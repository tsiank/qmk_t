...
void IS31fl3733_update_pwm_buffers(uint8_t addr1, uint8_t addr2) {
    if (g_pwm_buffer_update_required) {
        ...
        IS31fl3733_write_register(addr2, ISSI_COMMANDREGISTER_WRITELOCK, 0xC5);
        IS31fl3733_write_register(addr2, ISSI_COMMANDREGISTER, ISSI_PAGE_PWM);
...
void IS31fl3733_update_led_control_registers(uint8_t addr1, uint8_t addr2) {
    if (g_led_control_registers_update_required) {
        ...
        IS31fl3733_write_register(addr2, ISSI_COMMANDREGISTER_WRITELOCK, 0xC5);
        IS31fl3733_write_register(addr2, ISSI_COMMANDREGISTER, ISSI_PAGE_LEDCONTROL);
        for (int i = 0; i < 24; i++) {
